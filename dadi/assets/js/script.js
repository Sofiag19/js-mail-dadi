...
if (dadoUtente > dadoPc) {
  scrittaId.innerHTML = mess + " : Complimenti! <br>HAI VINTO!"
  console.log(mess + " : Complimenti! Hai vinto!");
}else if (dadoUtente < dadoPc) {
  scrittaId.innerHTML = mess + " : Mi dispiace! <br>HAI PERSO!";
  console.log(mess + " : Mi dispiace! Hai perso!");
}else {
  scrittaId.innerHTML = "Avete totalizzato lo stesso punteggio! <br>Clicca su GIOCA per battere il pc.";
